...
def create_dosing_tab(parent):
    dosing_tab = QWidget()
    layout = QVBoxLayout(dosing_tab)
    
    grid = QGridLayout()
    grid.setSpacing(10)
    
    # Patient Weight
    grid.addWidget(QLabel("Patient Weight:"), 0, 0, alignment=Qt.AlignmentFlag.AlignRight)
    ...
    # Dose (mg)
    grid.addWidget(QLabel("Dose (mg):"), 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
    ...
    # Dosing Frequency
    grid.addWidget(QLabel("Dosing Frequency:"), 2, 0, alignment=Qt.AlignmentFlag.AlignRight)
